...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-04-2024 a las 19:51:08
...
INSERT INTO `beneficios` (`id_beneficio`, `nombre_beneficio`, `fecha_llegada`, `status`) VALUES
(1, 'Bono Alimenticio', '2024-04-10', 'Activo'),
(2, 'comunitario', '0000-00-00', 'Activo'),
(3, 'comunitario', '0000-00-00', 'Activo');
...
CREATE TABLE `casa` (
  ...
  `nombre_casa` varchar(60) DEFAULT NULL,
  `ten_casa` enum('Propia','Alquilada') NOT NULL,
  `status_casa` enum('Activo','Inactivo') NOT NULL,
...
INSERT INTO `casa` (`id_casa`, `id_manzana`, `id_persona`, `id_grupo_familiar`, `nombre_casa`, `ten_casa`, `status_casa`, `direccion`, `id_estado`, `id_ciudad`) VALUES
(1, 1, 1, 1, 'Los Huerfanos', 'Propia', 'Activo', '', 0, 0),
(2, 1, 1, 1, 'Torrealba', 'Propia', 'Activo', 'av 20 entre calles 16 y 17 barrio bolivar libertador, quibor estado lara', 0, 0);
...
(1, 1, 'Santa Eduviges', 'Ubicada por el cardenalito del oeste', 'Actualmente cuenta con 5 manzanas');
...
CREATE TABLE `grupo_familiar` (
  `id_grupo_flia` int(11) NOT NULL,
  `Status` enum('Activo','Inactivo') DEFAULT NULL,
  `nombre_familia` varchar(60) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `grupo_familiar` (`id_grupo_flia`, `Status`, `nombre_familia`) VALUES
(1, 'Activo', 'Vasquez ');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `historico_beneficios`
--

CREATE TABLE `historico_beneficios` (
  `id_hist_beneficio` int(11) NOT NULL,
  `id_jefe_equipo` int(11) NOT NULL,
  `id_grupo_familiar` int(11) DEFAULT NULL,
  `id_beneficio` int(11) DEFAULT NULL,
  `id_manzana` int(11) DEFAULT NULL,
  `id_nro_casa` int(11) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `historico_beneficios`
--

INSERT INTO `historico_beneficios` (`id_hist_beneficio`, `id_jefe_equipo`, `id_grupo_familiar`, `id_beneficio`, `id_manzana`, `id_nro_casa`, `fecha`, `descripcion`, `status`, `id_usuario`, `obsevacion`) VALUES
(1, 1, 1, 1, 1, 1, '2024-04-10', 'Este beneficio fue entregado el 10 de abril del 2024', 'Entregado', 0, '0');
...
CREATE TABLE `manzana` (
  ...
  `nombre_manzana` varchar(60) DEFAULT NULL,
  `descripcion` varchar(255) DEFAULT NULL,
  `observacion` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `manzana` (`id_manzana`, `id_casa`, `nombre_manzana`, `descripcion`, `observacion`) VALUES
(1, 1, 'Manzana 1', 'cuenta con 10 casas y 10 habitantes', 'Ninguna observacion');
...
CREATE TABLE `parentesco` (
  ...
  `parentesco` enum('Padre','Madre','Hijo','Hermano','Nieto') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `parentesco` (`id_parentesco`, `id_usuario`, `parentesco`) VALUES
(1, 1, 'Padre');
...
CREATE TABLE `persona` (
  ...
  `serial_carnet_patria` varchar(10) NOT NULL,
  `codigo_carnet_patria` varchar(10) NOT NULL,
...
INSERT INTO `persona` (`id_persona`, `id_tipo_usuario`, `id_parentesco`, `tipo_cedula`, `cedula`, `numero_hijos`, `id_grupo_familiar`, `nombre_completo`, `fecha_nacimiento`, `sexo`, `telefono`, `correo`, `serial_carnet_patria`, `codigo_carnet_patria`, `fecha_registro`, `status`) VALUES
(1, 1, 0, 'Venezolano', 31204020, 0, 1, 'jhon', '2003-11-25', 'Masculino', '04245421697', 'kacosvasquez14@gmail.com', '123456789', '123456789', '2024-04-09', 'Activo');
...
INSERT INTO `salud` (`id_salud`, `nombre_enfermedad`, `observacion`, `fecha_registro`) VALUES
(1, 'Ninguna', 'ninguna', '2024-04-03');
...
CREATE TABLE `seguridad` (
  `id_preguntas` int(50) NOT NULL,
  `id_usuario` int(50) NOT NULL,
  `preguntas_de_seguridad` enum('Ingrese su Pregunta') NOT NULL,
...
INSERT INTO `seguridad` (`id_preguntas`, `id_usuario`, `preguntas_de_seguridad`, `respuesta`) VALUES
(1, 1, 'Ingrese su Pregunta', 'color favorito: rojo'),
(2, 2, 'Ingrese su Pregunta', 'color favorito: negro');
...
CREATE TABLE `tipo_usuario` (
  `id_tipo_usuario` int(11) NOT NULL,
  `id_usuario` int(11) DEFAULT NULL,
  `jefe_equipo` enum('Jefe Familia','Jefe Manzana','Jefe UBCH') NOT NULL,
...
INSERT INTO `tipo_usuario` (`id_tipo_usuario`, `id_usuario`, `jefe_equipo`, `fecha_registro`, `status`) VALUES
(1, 1, 'Jefe Familia', '2024-04-03', 'Activo');
...
INSERT INTO `usuario` (`id_usuario`, `nombre_completo`, `usuario`, `contraseña`, `correo`, `id_grupo_familiar`, `id_tipo_usuario`, `status`) VALUES
(1, '', 'Admin', 'e3afed0047b08059d0fada10f400c1e5', '', 1, 1, 'Activo'),
(2, '', 'usuario', '4d186321c1a7f0f354b297e8914ab240', '', 2, 2, 'Activo'),
(3, '', 'admin', '21232f297a57a5a743894a0e4a801fc3', '', 3, 3, 'Activo'),
(4, '', 'Gabriel', '827ccb0eea8a706c4c34a16891f84e7b', 'mnaddsnavlks', 1, 1, 'Activo');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `usuario_grupo_familiar`
--

CREATE TABLE `usuario_grupo_familiar` (
  `id_usuario_g_f` int(11) NOT NULL,
  `id_usuario` int(11) NOT NULL,
  `id_grupo_familiar` int(11) NOT NULL,
  `parentesco` enum('Padre','Madre','Hermano','Hermana','Hijo') NOT NULL,
  `jefe_familia` enum('Activo','Inactivo') NOT NULL,
  `id_casa` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `usuario_grupo_familiar`
--

INSERT INTO `usuario_grupo_familiar` (`id_usuario_g_f`, `id_usuario`, `id_grupo_familiar`, `parentesco`, `jefe_familia`, `id_casa`) VALUES
(1, 1, 1, 'Padre', 'Activo', 1);
...
--
-- Indices de la tabla `historico_beneficios`
--
ALTER TABLE `historico_beneficios`
  ADD PRIMARY KEY (`id_hist_beneficio`),
  ADD KEY `id_nro_casa` (`id_nro_casa`);
...
--
-- Indices de la tabla `usuario_grupo_familiar`
--
ALTER TABLE `usuario_grupo_familiar`
...
--
ALTER TABLE `grupo_familiar`
  MODIFY `id_grupo_flia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `historico_beneficios`
--
ALTER TABLE `historico_beneficios`
  MODIFY `id_hist_beneficio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `manzana`
--
ALTER TABLE `manzana`
  MODIFY `id_manzana` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `seguridad`
  MODIFY `id_preguntas` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT de la tabla `usuario_grupo_familiar`
--
ALTER TABLE `usuario_grupo_familiar`
  MODIFY `id_usuario_g_f` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
